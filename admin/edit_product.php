...
<head>
    ...
    <title>Website  Coffeee - Edit Products page</title>
</head>
<body>
<?php include '../components/admin_header.php';?>
    ...
    <div class="main">
        ...
        <div class="title2">
            <a href="dashboard.php" style="text-decoration: none">Home</a><span> / Edit products</span>
        </div>
        ...
        <section class="edit-post">
            ...
            <div class="form-container">
                <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="olde_image" value="<?= $fetch_product['image'];?>">
                    ...
                    <div class="input-field">
                        ...
                        <select name="status">
                            <option select disabled value="<?= $fetch_product['status']?>"><?= $fetch_product['status']?></option>
                    ...
                    <div class="input-field">
                        ...
                        <input type="file" name="old_image" accept="image/*">
                        <img src="../image/<?= $fetch_product['image']; ?>">
                    </div>

                    <div class="flex-btn">
                        <button type="submit" name="update" class="btn-vp">Update Product</button>
                        <a href="view_product.php" class="btn-vp">Go back</a>
                        <button type="submit" name="delete" class="btn-vp">Delete Product</button>
                    </div>
                </form>
            </div>
